...
<input id="currentPath" value="<%=basePath%>" type="hidden">
	<div class="site-wrapper search-result" id="list-page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<a href='index.jsp'>首页</a><span class="sep">&gt;</span> <span>搜索结果</span>
			</div>
		</div>
		<div class="content">
			<div class="container">
				<div class="crumbs-nav">
					<div class="crumbs-nav-item">
						“<strong class="search-key">${sessionScope.searchValue}</strong>” 相关的商品
					</div>
				</div>
			</div>
			<div class="container">
						...
						<c:forEach items="${sessionScope.goodsList }" var="list">
							...
							<div class="goods-item">
								<div class="figure figure-img">
									<a href="detail.jsp"> <img src="${list.url }" width="200"
										height="200" alt="" />
									</a>
								</div>
								<p class="desc">${list.description }${list.url }</p>
								<h2 class="title">
